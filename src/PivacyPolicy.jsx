    ...
    return (
        <div className="p-8 min-h-screen w-screen">
            ...
            <div className="w-fit mx-auto max-w-xl">
                ...
                <h2 className="mb-2 text-xl font-semibold">1. Datenschutz auf einen Blick</h2>
                <h3 className="mb-1 text-lg font-semibold">Allgemeine Hinweise</h3>
                <p className="mb-4">
                    Die folgenden Hinweise geben einen einfachen &Uuml;berblick dar&uuml;ber,
                    was mit Ihren personenbezogenen Daten passiert, wenn Sie diese Website besuchen. Personenbezogene
                ...
                <h3 className="mb-1 text-lg font-semibold">Datenerfassung auf dieser Website</h3>
                ...
                <h4 className="mb-0.5 text-base font-semibold">Wie erfassen wir Ihre Daten?</h4>
                <p className="mb-4">
                ...
                <h4 className="mb-0.5 text-base font-semibold">Wof&uuml;r nutzen wir Ihre Daten?</h4>
                <p className="mb-4">
                    Ein Teil der Daten wird erhoben, um eine fehlerfreie Bereitstellung der Website zu
                    gew&auml;hrleisten. Andere Daten k&ouml;nnen zur Analyse Ihres Nutzerverhaltens verwendet werden.
                </p>
                <h4 className="mb-0.5 text-base font-semibold">Welche Rechte haben Sie bez&uuml;glich Ihrer Daten?</h4>
                <p className="mb-4">
                ...
                <h2 className="mb-2 text-xl font-semibold">2. Hosting</h2>
                <p className="mb-4">
                    Wir hosten die Inhalte unserer Website bei folgendem Anbieter:
                </p>
                <h3 className="mb-1 text-lg font-semibold">Externes Hosting</h3>
                <p className="mb-4">
                ...
                <h4 className="mb-0.5 text-base font-semibold">Auftragsverarbeitung</h4>
                <p className="mb-4">
                ...
                <h2 className="mb-2 text-xl font-semibold">3. Allgemeine Hinweise und Pflicht&shy;informationen</h2>
                <h3 className="mb-1 text-lg font-semibold">Datenschutz</h3>
                <p className="mb-4">
                ...
                <h3 className="mb-1 text-lg font-semibold">Hinweis zur verantwortlichen Stelle</h3>
                <p className="mb-4">
                ...
                <h3 className="mb-1 text-lg font-semibold">Speicherdauer</h3>
                <p className="mb-4">Soweit innerhalb dieser Datenschutzerkl&auml;rung keine speziellere Speicherdauer
                    genannt wurde, verbleiben Ihre personenbezogenen Daten bei uns, bis der Zweck f&uuml;r die
                    Datenverarbeitung entf&auml;llt. Wenn Sie ein berechtigtes L&ouml;schersuchen geltend machen oder
                    eine Einwilligung zur Datenverarbeitung widerrufen, werden Ihre Daten gel&ouml;scht, sofern wir
                ...
                <p className="mb-4">
                    ...
                    Grundlage von &sect;25 Abs. 1 TTDSG. Die Einwilligung ist jederzeit widerrufbar. Sind Ihre Daten zur
                ...
                <h3 className="mb-1 text-lg font-semibold">Empfänger von personenbezogenen Daten</h3>
                <p className="mb-4">
                ...
                <h3 className="mb-1 text-lg font-semibold">Widerruf Ihrer Einwilligung zur Datenverarbeitung</h3>
                <p className="mb-4">
                ...
                <h3 className="mb-1 text-lg font-semibold">Recht auf Daten&shy;&uuml;bertrag&shy;barkeit</h3>
                <p className="mb-4">
                ...
                <h3 className="mb-1 text-lg font-semibold">Auskunft, Berichtigung und L&ouml;schung</h3>
                <p className="mb-4">
                ...
                <h3 className="mb-1 text-lg font-semibold">Recht auf Einschr&auml;nkung der Verarbeitung</h3>
                <p className="mb-4">
                ...
                <h3 className="mb-1 text-lg font-semibold">SSL- bzw. TLS-Verschl&uuml;sselung</h3>
                <p className="mb-4">
                ...
                <h3 className="mb-1 text-lg font-semibold">Widerspruch gegen Werbe-E-Mails</h3>
                <p className="mb-4">
                ...
                <h2 className="mb-2 text-xl font-semibold">4. Datenerfassung auf dieser Website</h2>
                <h3 className="mb-1 text-lg font-semibold">Server-Log-Dateien</h3>
                <p className="mb-4">
                ...
                <h3 className="mb-1 text-lg font-semibold">Kontaktformular</h3>
                <p className="mb-4">
                ...
                <h3 className="mb-1 text-lg font-semibold">Anfrage per E-Mail, Telefon oder Telefax</h3>
                <p className="mb-4">
                ...
                <h2 className="mb-2 text-xl font-semibold">5. Newsletter</h2>
                <h3 className="mb-1 text-lg font-semibold">Newsletter&shy;daten</h3>
                <p className="mb-4">
                    Wenn Sie den auf der Website angebotenen Newsletter beziehen m&ouml;chten, ben&ouml;tigen wir von
                ...
                <p className="mb-4">
                    ...
                    Newsletters k&ouml;nnen Sie jederzeit widerrufen, etwa &uuml;ber den &bdquo;Austragen&ldquo;-Link im
                    Newsletter. Die Rechtm&auml;&szlig;igkeit der bereits erfolgten Datenverarbeitungsvorg&auml;nge
                ...
                <p className="mb-4">
                    ...
                    der Abbestellung des Newsletters oder nach Zweckfortfall aus der Newsletterverteilerliste
                    gel&ouml;scht. Wir behalten uns vor, E-Mail-Adressen aus unserem Newsletterverteiler nach eigenem
                    Ermessen im Rahmen unseres berechtigten Interesses nach Art. 6 Abs. 1 lit. f DSGVO zu l&ouml;schen
                    oder zu sperren.
                </p>
                <p className="mb-4">
                ...
                <p className="mb-4">
                    ...
                    Zweck verwendet und nicht mit anderen Daten zusammengef&uuml;hrt. Dies dient sowohl Ihrem Interesse
                    als auch unserem Interesse an der Einhaltung der gesetzlichen Vorgaben beim Versand von Newslettern
                    (berechtigtes Interesse im Sinne des Art. 6 Abs. 1 lit. f DSGVO). Die Speicherung in der Blacklist
                    ist zeitlich nicht befristet. <strong>Sie k&ouml;nnen der Speicherung widersprechen, sofern Ihre
